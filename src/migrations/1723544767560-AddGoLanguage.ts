...
export class AddGoLanguage1723544767560 implements MigrationInterface {
    name = 'AddGoLanguage1723544767560'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."interviews_language_enum" RENAME TO "interviews_language_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."interviews_language_enum" AS ENUM('javascript', 'typescript', 'go')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."code_tasks_language_enum" AS ENUM('javascript', 'typescript', 'go')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."IDX_4cf1c5db43b9a7d758a4fc086c"`);
        await queryRunner.query(`CREATE TYPE "public"."code_tasks_language_enum_old" AS ENUM('javascript', 'typescript')`);
        await queryRunner.query(`ALTER TABLE "code_tasks" ALTER COLUMN "language" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_4cf1c5db43b9a7d758a4fc086c" ON "code_tasks" ("title", "language") `);
        await queryRunner.query(`CREATE TYPE "public"."interviews_language_enum_old" AS ENUM('javascript', 'typescript')`);
        await queryRunner.query(`ALTER TABLE "interviews" ALTER COLUMN "language" DROP DEFAULT`);
